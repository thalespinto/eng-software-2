...
const ConfirmationScreen = () => {
  ...
  const passengerCount = RideContext
    ? RideContext.RideInfos.passengerCount
    : "";
    ...
    <View style={styles.container}>
      ...
      <View style={styles.switchContainer}>
        <Text style={styles.switchLabel}>
          Aceitar automaticamente passageiros:
        </Text>
        <Switch
          testID="autoAcceptSwitch"
      ...
      <TouchableOpacity testID="confirmRideButton" onPress={handleSubmit} style={styles.submitButton}>
